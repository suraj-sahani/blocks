...
const SignupForm = () => {
  ...
  // When image upload starts, we disable the submit button
  const onUploadStart = () => setDisable(true);
  // When image upload is complete, we set the url in the form and enable the submit button
  const onUploadComplete = (res: IKUploadResponse) => {
